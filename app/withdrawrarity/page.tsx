...
import { CAYC_RARITY_NFT_ABI } from "@/config/ABI/CAYC_RARITY_NFT_ABI";
...
import { CAYC_RARITY_NFT_ADDRESS } from "@/config/addresses";
        ...
        <div className=" md:w-[800px] rounded-md w-full gap-y-10">
          <Card className="bg-transparent border-none shadow-none bg-neutral-900 text-white">
            <CardHeader className="gap-4">
              <CardTitle className="text-white">RARITY Public Stage</CardTitle>
                ...
                <div className="w-full">
                  <Button
                    ...
                    onClick={() =>
                      writeContract(
                        {
                          abi: CAYC_RARITY_NFT_ABI,
                          address: CAYC_RARITY_NFT_ADDRESS,
