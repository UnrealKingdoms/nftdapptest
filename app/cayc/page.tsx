        ...
        <div className="w-5/6 md:w-3/4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 rounded-md w-full mt-10 lg:mt-16 gap-y-10">
            <article className="prose lg:prose-sm prose-h3:text-xl prose-h3:font-bold w-full lg:w-[90%]">
              <h3 className="text-white">About Cyber Ape Yacht Club</h3>
              <p className="text-neutral-500 font-medium">
                Cyber Ape Yacht Club (CAYC) is all about Utility, Reimagined.
              </p>
              <p className="text-neutral-500 font-medium">
                Focused on creating the Multiverse Metaverse, called Unreal
                Kingdoms, and defining the future of Gambling. CAYC has patents
                for Web3 Gambling, Ticketing Sales, and Streaming and ongoing
                partnerships with Sporting Agencies, Gaming, Apparel, Education
                and many more.
              </p>
              <p className="text-neutral-500 font-semibold">
                The CAYC NFT holders benefit from our Web3 Casino with Exclusive
                Casino Bonuses. A dedicated Crypto Exchange (cayc.exchange). An
                e-commerce mystery box site (Cayc Cases). The world’s first
                Multiverse Metaverse (Unreal Kingdoms) and more to come.
              </p>
              <p className="text-neutral-500 font-semibold">
                CAYC will provide streaming casino content for users via
                multiple streaming platforms. Any Earnings are for in game
                credits ONLY, not a financial gain. CAYC is a Cyprus Company
                owned by - Eight Galaxies B.V.
              </p>
            </article>
